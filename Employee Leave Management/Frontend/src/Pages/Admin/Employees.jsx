...
const Employees = () => {
  ...
  const fetchEmployees = async () => {
    try {
      const response = await axios.get("  https://employee-leave-manage.onrender.com/api/employees/getemp");
  ...
  const deleteEmployee = async (id) => {
    try {
      await axios.delete(`  https://employee-leave-manage.onrender.com/api/employees/delete/${id}`);
            ...
            {employees.map((employee) => (
              ...
              >
                <td className="p-4 flex items-center gap-3">
                  ...
                  {/* Employee Image */}
                  <img
                    src={`  https://employee-leave-manage.onrender.com/uploads/${employee.image}`}
                    alt={employee.name}
